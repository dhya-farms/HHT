    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("icon", models.ImageField(blank=True, null=True, upload_to="merchandise/category_icons/")),
                ("image", models.ImageField(blank=True, null=True, upload_to="merchandise/category_images/")),
                (
                    "placeholder",
                    models.ImageField(blank=True, null=True, upload_to="merchandise/category_placeholders/"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("name", models.CharField(max_length=255, unique=True)),
                ("description", models.TextField(blank=True, null=True)),
                ("icon", models.ImageField(blank=True, null=True, upload_to="merchandise/collection_icons/")),
                ("image", models.ImageField(blank=True, null=True, upload_to="merchandise/collection_images/")),
                (
                    "placeholder",
                    models.ImageField(blank=True, null=True, upload_to="merchandise/collection_placeholders/"),
                ),
                ("active", models.BooleanField(default=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("coupons", models.ManyToManyField(blank=True, related_name="products", to="products.coupon")),
            ],
        ),
        migrations.CreateModel(
            name="Supplier",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("name", models.CharField(max_length=255)),
                ("icon", models.ImageField(blank=True, null=True, upload_to="merchandise/tag_icons/")),
            ],
        ),
        migrations.CreateModel(
            name="ProductVariant",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("image", models.ImageField(blank=True, null=True, upload_to="merchandise/product_images/")),
                (
                    "placeholder",
                    models.ImageField(blank=True, null=True, upload_to="merchandise/product_placeholders/"),
                ),
