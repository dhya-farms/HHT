...
DEPLOYMENT_ENVIRONMENT = os.environ.get("DEPLOYMENT_ENVIRONMENT")  # local.env or prod.env
...
ENV_FILE = env.read_env(BASE_DIR / f"{DEPLOYMENT_ENVIRONMENT}.env")
# READ_DOT_ENV_FILE = env.bool("DJANGO_READ_DOT_ENV_FILE", default=False)
# if READ_DOT_ENV_FILE:
#     # OS environment variables take precedence over variables from .env
#     env.read_env(str(BASE_DIR / ".env"))
print(BASE_DIR / f"{DEPLOYMENT_ENVIRONMENT}.env")
print(ENV_FILE)
...
LOCAL_APPS = [
    ...
    "app.shippings.apps.ShippingsConfig",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "app.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""Siva Prakash""", "siva-prakash@dhya.in")]
